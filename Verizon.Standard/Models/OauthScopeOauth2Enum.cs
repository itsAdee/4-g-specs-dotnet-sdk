// <copyright file="OauthScopeOauth2Enum.cs" company="APIMatic">
...
namespace Verizon.Standard.Models
{
    ...
    static class OauthScopeOauth2EnumExtention
    {
        internal static string GetValues(this IEnumerable<OauthScopeOauth2Enum> values)
        {
