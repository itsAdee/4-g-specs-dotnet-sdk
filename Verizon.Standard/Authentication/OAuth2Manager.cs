...
namespace Verizon.Standard.Authentication
{
    ...
    public class OAuth2Manager : AuthManager, IOauth2Credentials
    {
        ...
        internal OAuth2Manager(Oauth2Model oauth2)
        {
            ...
            OauthScopes = oauth2?.OauthScopes;
        ...
        /// </summary>
        public List<Models.OauthScopeOauth2Enum> OauthScopes { get; }
        ...
        public bool Equals(string oauthClientId, string oauthClientSecret, Models.OauthToken oauthToken, List<Models.OauthScopeOauth2Enum> oauthScopes)
        {
        ...
        {
            var token = await oAuthApi?.Invoke().RequestTokenOauth2Async(BuildBasicAuthheader(),
    ...
    public sealed class Oauth2Model
    {
        ...
        internal List<Models.OauthScopeOauth2Enum> OauthScopes { get; set; }
        ...
        public class Builder
        {
            ...
            private List<Models.OauthScopeOauth2Enum> oauthScopes;
            ...
            /// <returns>Builder.</returns>
            public Builder OauthScopes(List<Models.OauthScopeOauth2Enum> oauthScopes)
            {
